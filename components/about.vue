<template>
  <article>
    <div class="container mx-auto px-4">
      <div
        class="xl:flex xxl:flex xxl:justify-between xl:justify-between xl:flex-row-reverse xxl:flex-row-reverse"
      >
        <div>
          <p
            class="font-sans font-extrabold text-3xl xl:text-6xl xxl:text-6xl text-gray-800 text-center xl:mt-20 xxl:mt-20 xl:text-right xxl:text-right xxl:mr-16 xl:mr-16"
          >
            <span
